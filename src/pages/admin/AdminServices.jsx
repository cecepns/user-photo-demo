...
const AdminServices = () => {
  ...
  const fetchServices = async (searchQuery = '') => {
    try {
      const base = 'https://api.kingcreativestudio.my.id/user-photo/api/services';
  ...
  const fetchAvailableItems = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-photo/api/items');
      const data = await response.json();
  ...
  const fetchServiceItems = async (serviceId) => {
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-photo/api/services/${serviceId}/items`);
      const data = await response.json();
  ...
  const handleDeleteService = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-photo/api/services/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
  ...
  const handleDeleteServiceItem = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-photo/api/service-items/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
