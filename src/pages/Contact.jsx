...
const Contact = () => {
    ...
    const loadHero = async () => {
      try {
        const response = await fetch(
          'https://api-inventory.isavralabel.com/chekusphoto/api/content-sections/contact_hero_section'
        );
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/chekusphoto/api/contact', {
        method: 'POST',
        headers: {
