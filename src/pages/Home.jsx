...
const Home = () => {
  ...
  const fetchHeroContent = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/chekusphoto/api/content-sections/hero_section');
      if (response.ok) {
  ...
  const fetchServicesContent = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/chekusphoto/api/content-sections/services_preview_section');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchServiceCards = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/chekusphoto/api/service-cards?card_type=service');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchCtaContent = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/chekusphoto/api/content-sections/home_cta_section');
      if (response.ok) {
        const data = await response.json();
        setCtaContent(data);
      }
  ...
  return (
    <>
      <Helmet>
        <title>Chekusphoto - Hari Pernikahan Sempurna Anda Menanti</title>
        <meta
          name="description"
          content="Ciptakan momen magis bersama Chekusphoto. Layanan perencanaan pernikahan profesional untuk membuat hari spesial Anda tak terlupakan."
        />
        <meta
          name="keywords"
